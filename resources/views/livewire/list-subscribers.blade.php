            ...
            <div class="table-responsive">
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        @else
                            <li class="page-item"><a class="page-link" wire:click="previousPage" href="javascript:void(0)">&laquo;</a></li>
                        @endif
                        ...
                        @if ($subscribers->hasMorePages())
                            <li class="page-item"><a class="page-link" wire:click="nextPage" href="javascript:void(0)">&raquo;</a></li>
                        @else
